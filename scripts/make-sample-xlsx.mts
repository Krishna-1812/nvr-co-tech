...
const base: ExportRow = {
  voucher_no: 'FI/HYD/25-26/0042', status: 'approved', date: '2026-02-14',
...
const rows: ExportRow[] = [
  base,
  { ...base, voucher_no: 'FI/BOM/25-26/0018', status: 'pending_second',
  ...
  { ...base, voucher_no: 'FI/DEL/25-26/0007', status: 'paid',
