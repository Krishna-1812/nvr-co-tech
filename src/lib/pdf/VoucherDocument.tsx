      ...
      <Page size="A4" orientation="landscape" style={s.page}>
          ...
          <View style={s.header}>
            <View style={{ width: '24%' }}>
              <Text style={s.wordmark}>
                N<Text style={{ color: ACCENT }}>V</Text>R
              </Text>
              <Text style={s.wordmarkSub}>N V R &amp; Co</Text>
            </View>

            <View style={[s.titleBlock, { width: '40%' }]}>
              <Text style={s.firmName}>N V R &amp; Co</Text>
        ...
        <View style={s.foot} fixed>
          <Text style={s.footText}>
            {v.voucher_no ?? 'Draft'} · Generated by NVR Voucher
          </Text>
          <Text
            style={s.footText}
