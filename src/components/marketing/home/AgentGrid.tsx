 ...
 * six identical tiles implying six shipped products — buys a click and loses
 * the relationship on the next page, which is a bad trade with an audience that
 * is professionally suspicious.
 */
        ...
        <div className="mt-14 grid gap-4 md:grid-cols-2 lg:grid-cols-3">
          {AGENTS.map((agent, i) => (
            <Reveal key={agent.slug} delay={(i % 3) * 70}>
              ...
              >
                {/* Accent bloom, sitting in the corner behind the content. */}
                <span
                  aria-hidden
                ...
                <span className="m-mono relative mt-6 inline-flex items-center gap-1.5 text-[10px] tracking-[0.14em] uppercase transition-colors group-hover:text-[var(--m-cyan)]">
                  Explore
                  <ArrowRight
